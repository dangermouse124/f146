	...
	<h2><font color="black">Add form</font></h2>
        <form id="f146_entry" action="submit_month.php" method="POST">
            ...
            while ($row = mysqli_fetch_array($result,MYSQLI_ASSOC)) {
                    ...
                    echo "<td><input type='number' name='previous" . $cnt . "' id='previous". $cnt ."' value=0 style='width: 4em'></td>";
                    echo "<td><input type='number' name='rx" . $cnt . "' id='rx". $cnt ."' value=0 style='width: 4em'></td>";
                    echo "<td><input type='number' name='used" . $cnt . "' id='used". $cnt ."' value=0 style='width: 4em'><span id='left" . $cnt . "'></span></td>";
